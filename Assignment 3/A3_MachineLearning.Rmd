...
>>>>>>> 865ef5c6a967bd8b739ca6efb0a0d94f3b3a7192
)
...
xlab('Intercept') +
labs(title="Intercept: PPU-check of effect size (informed data)") +
theme_classic()
...
xlab('Beta') +
labs(title="v1: PPU-check of effect size (informed data)") +
theme_classic()
...
xlab('Beta') +
labs(title="v2: PPU-check of effect size (informed data)") +
theme_classic()
...
xlab('Beta') +
labs(title="v3:PPU-check of effect size (informed data)") +
theme_classic()
...
xlab('Beta') +
labs(title="v4: PPU-check of effect size (informed data)") +
theme_classic()
...
xlab('Beta') +
labs(title="v5: PPU-check of effect size (informed data)") +
theme_classic()
...
xlab('Beta') +
labs(title="v6: PPU-check of effect size (informed data)") +
theme_classic()
...
xlab('Beta') +
labs(title="v7: PPU-check of effect size (informed data)") +
theme_classic()
...
xlab('Beta') +
labs(title="v_8 PPU-check of effect size (informed data)") +
theme_classic()
...
xlab('Beta') +
labs(title="v9: PPU-check of effect size (informed data)") +
theme_classic()
...
xlab('Beta') +
labs(title="v10: PPU-check of effect size (informed data)") +
theme_classic()
...
relevant_cols <- t %>% dplyr::select(Harmonicity_SD,
                                     F0_SD_Praat, 
                                     Clarity_Mean, 
                                     HMPDD0_SD, 
                                     Pitch_MAD, 
...
# Fitting the model to the processed data
```{r}
f1_real <- bf(Diagnosis ~ 1 + Harmonicity_SD + F0_SD_Praat + Clarity_Mean + HMPDD0_SD + Pitch_MAD + MCEP17_Mean + CreakProbability_SD + MCEP2_Mean + MCEP8_Mean + MCEP23_Mean + (1+Trial|NewID))
```


```{r}
#Keeping the prior priors
...
xlab('Beta') +
labs(title="F0_SD_Praat: PPU-check of the slope") +
theme_classic()
...
geom_histogram(aes(prior_b), fill="darkblue", color="black",alpha=0.6, bins = 30) +
geom_histogram(aes(b_Pitch_MAD), fill="red", color="black",alpha=0.6, bins = 30)+
xlab('Beta') +
labs(title="Pitch_MAD: PPU-check of the slope") +
theme_classic()

p_real6 <- ggplot(m1_real_posterior) +
geom_histogram(aes(prior_b), fill="darkblue", color="black",alpha=0.6, bins = 30) +
geom_histogram(aes(b_MCEP17_Mean), fill="red", color="black",alpha=0.6, bins = 30)+
xlab('Beta') +
labs(title="MCEP17_Mean: PPU-check of the slope") +
theme_classic()
...
xlab('Beta') +
labs(title="MCEP2_Mean: PPU-checkof the slope") +
theme_classic()
...
geom_histogram(aes(prior_b), fill="darkblue", color="black",alpha=0.6, bins = 30) +
geom_histogram(aes(b_MCEP23_Mean), fill="red", color="black",alpha=0.6, bins = 30)+
xlab('Beta') +
labs(title="MCEP23_Mean: PPU-check of the slope") +
theme_classic()
...
fun_if <- function(x) {ifelse(x > 0.5, "HC", "SCZ")}
...
for (i in seq(1000)) {
  ...
  train_select$pred <- factor(train_select$pred, levels=c('SCZ', 'HC'))
  test_real$pred <- c(test_r[i,])
  test_real <- unnest(test_real, pred)
  test_real$pred <- factor(test_real$pred, levels=c('SCZ', 'HC'))
