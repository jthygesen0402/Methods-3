...
=======
>>>>>>> 2a0c4ce0e328077bd24c1ff011e4f86fddd70083
...
cutoffs <- findCorrelation(cor(train_num), cutoff = 0.7)
...
#Trying to do feature selcetion.. it's not really working
```{r}
control <- rfeControl(functions = nbFuncs , 
                      method = "repeatedcv",
                      verbose = F)

y_train <- train_real$Diagnosis %>% unlist()
