...
results <- rfe(train_real[-which(names(train_real) == "Diagnosis")], train_real["Diagnosis"], sizes=c(1:8), rfeControl=control)
...
train_real[-which(names(train_real) == "Diagnosis")]
```
...
am_i_important <- explain_tidymodels(informed_SVM, 
                                     data = train_real, 
                                     y= as.numeric(train_real$Diagnosis)-1,
                                     label= "SVM", 
                                     verbose = FALSE)
