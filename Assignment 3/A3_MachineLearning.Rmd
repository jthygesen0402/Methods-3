...
=======
```{r}
relevant_cols <- t %>% dplyr::select(Harmonicity_SD, HMPDD0_SD, Clarity_Mean, MCEP2_Mean, CreakProbability_SD, F0_SD_Praat, Pitch_IQR, MCEP23_Mean, MCEP8_Median, Intensity_SD_Praat)

train_select <- cbind(train_factor, relevant_cols)
```

```{r}
f1_real <- bf(Diagnosis ~ 1 + Harmonicity_SD+ HMPDD0_SD+ Clarity_Mean+ MCEP2_Mean+ CreakProbability_SD+ F0_SD_Praat+ Pitch_IQR+ MCEP23_Mean+ MCEP8_Median+ Intensity_SD_Praat + (1+Trial|NewID))
```
...
>>>>>>> 07778b749e68712039eb5f2c0ec46e026dd020b0
