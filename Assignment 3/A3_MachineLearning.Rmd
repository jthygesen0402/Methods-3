...
ef <- data.frame(Map(rnorm, people, trials, sd=trials)) %>% mutate(ID = seq(1:people))

names(sim_d) <- c(paste("v", seq(1,10)),"ID")
...
=======
```
>>>>>>> 1bc09d794a3185bd1665c2cc1ce3facf9739ee42
