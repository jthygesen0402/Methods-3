...
```{r}
#Centering the informed training data
...
```{r}
#Centering the noise training data
...
f1 <- bf(group ~ 1 + v1_obs_mat ched+ v2_obs_matched + v3_obs_matched + v4_obs_matched + v5_obs_matched + v6_obs_matched + v7_obs_matched + v8_obs_matched + v9_obs_matched + v10_obs_matched + (1+trial|ID))
