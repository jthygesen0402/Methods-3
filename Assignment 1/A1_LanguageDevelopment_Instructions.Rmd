...
#Plot the prior-posterior update plot for the slope:
ggplot(Posterior_m1) +
geom_histogram(aes(prior_b_diagnosisASD), fill="steelblue", color="black",alpha=0.6) +
geom_histogram(aes(b_diagnosisASD), fill="#FC4E07", color="black",alpha=0.6) +
geom_histogram(aes(b_diagnosisTD), fill = "green", color = "black", alpha=0.6)+
xlab('Intercept') +
labs(title="Prior-posterior update slope") +
theme_classic()
```
