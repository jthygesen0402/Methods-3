...
mu_change_ASD <- 0.4 #before 0.4 - beta
sigma_change_ASD <- 0.035 #before 0.4 - sd_beta

mu_change_TD <- 0.6 #before 0.6
sigma_change_TD <- 0.25 #before 0.2
error <- 0.1 #before 0.2
```
...
MLU_priors <- c(
  ...
  prior(normal(0.41,0.035), class = b, coef = "diagnosisASD"),
  prior(normal(0.41,0.25), class = b, coef = "diagnosisTD"),
  prior(normal(0,0.1),class=b,coef="DiagnosisASD:Visit"),
