...
d_df <- real_data_pitch %>% 
         HC=SAMPLE_SIZE_H  select(SAMPLE_SIZE_SZ,SAMPLE_SIZE_HC, Total, StudyID, FEMALE_SZ, FEMALE_HC, MALE_SZ,MALE_HC) %>% rename(SZ = SAMPLE_SIZE_SZ, 
C) 
...
>>>>>>> 26beb9ac82c723e6468025d8004ecb9cace23bd9
```
